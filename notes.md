...
You can specify one of four fonts, `serif`, `sans-serif`, `fixed`, and `symbol`. You can also import a font.
...
There are three ways to insert JS into HTML:
